...
package com.kuang.templateproject.widget;
...
import com.kuang.templateproject.utils.MMKVUtils;
import com.xuexiang.constant.TimeConstants;
import com.xuexiang.templateproject.R;
import com.kuang.templateproject.core.http.api.ApiService;
import com.kuang.templateproject.core.http.callback.NoTipCallBack;
import com.kuang.templateproject.core.http.entity.TipInfo;
...
public class GuideTipsDialog extends BaseDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public static void showTipsForce(Context context) {
        CustomRequest request = XHttp.custom().cacheMode(CacheMode.ONLY_REMOTE).cacheTime(TimeConstants.DAY).cacheKey("getTips");
